...
(function (e) {
	...
	e.extend(y, {
		...
		L: function (d, c, a) {
			if ("left" == d)
				return (
					(d = -a.f.b * a.k + a.e.b), 0 < c ? 0 : c < d ? d : c
				);
			d = -a.f.d * a.k + a.e.d;
		...
		I: function (d) {
			...
			a &&
				...
				a.K.css({
					width:
						a.f.b > Math.round(a.e.b / a.h)
							? Math.round(a.e.b / a.h)
							: a.f.b,
					height:
						a.f.d > Math.round(a.e.d / a.h)
							? Math.round(a.e.d / a.h)
							: a.f.d,
				}),
				a.J.css({
		...
		F: function (d, c, a) {
			...
			var b = e.extend({}, this.dsetting, c),
				...
				C = d.attr("data-text-bottom")
					? d.attr("data-text-bottom")
					: "",
				f = this,
				B,
				v,
			...
			if (0 === m.d || 0 === m.b)
				...
				b.descarea && e(b.descarea).length
					? 0 === e(b.descarea).width() ||
					  0 === e(b.descarea).height()
						? (b.descarea = r)
						: (b.magnifiersize = [
								e(b.descarea).width(),
								e(b.descarea).height(),
				...
				b.cursorshade &&
					(q
						...
						.css({
							...
							position: "absolute",
							width: Math.round(
								b.magnifiersize[0] / b.zoomstart
							),
							height: Math.round(
								b.magnifiersize[1] / b.zoomstart
							),
							top: 0,
							left: 0,
						})
